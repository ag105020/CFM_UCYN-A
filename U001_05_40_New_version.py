...
plot(RhRd[:ic],MuC3[:ic],linestyle=(0, (5, 3, 1, 3, 1, 3)),color='k')
plot(RhRd[ic:],MuN3[ic:],linestyle=(0, (5, 3, 1, 3, 1, 3)), color='k',label='Achievable')
plot(RhRd[ic],MuC3[ic],'o',color='k', label='Optimum')
plot((RhRd[ic],RhRd[ic]),(0,1.05),'--',linewidth=0.7, color='k')

legend(loc=4,bbox_to_anchor=(1,0.15),edgecolor='#404040',handlelength=3,fontsize = 9)
sf('','UCYN-A_new3',Dpi)
